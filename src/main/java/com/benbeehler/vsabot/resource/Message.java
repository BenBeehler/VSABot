...
public class Message {
	...
	public static final String NEW_DISCUSSION_WELCOME = "Hello,<br>"
			...
			+ "<a href='https://docs.google.com/document/d/1_aRCbrBKwKFMuXOPhpFTGP5lBLl9ErWElK1YanRzNDA'>this link</a>.<br><br>"
			+ "Thank you,<br>"
			+ "<i>VSABot 2.x</i><br>"
			+ "<br>"
	...
	public static String HELP_MESSAGE = "Hello! I am VSABot and I help the Student Moderators.<br>"
			...
			+ "<br>"
			+ "You can review the Student Commons guidelines at <a href='https://docs.google.com/document/d/1_aRCbrBKwKFMuXOPhpFTGP5lBLl9ErWElK1YanRzNDA'>this link.</a>";
